...
<style type="text/css">
 ...
 <a href="<?php echo base_url().''.$_GET['from']; ?>" style="display:flex; align-items:center; position: absolute; top: 3px; left: 255px; color:#4caf50;"><i class="fa fa-long-arrow-left" style="font-size: 31px; color: #4caf50; margin-right:9px;"></i>Back</a>
  ...
  <div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="x_content">
        ...
        <form method="post" action="<?php echo base_url()?>add_customer/update_user" id="user_form" data-parsley-validate class="form-horizontal form-label-left">
...
$ph = str_replace("+971", "", $ph);
$ph = str_replace("+91", "", $ph);

?>
                <input onchange="if(this.value.length < 1) {alert('Phone Number Is Required');this.focus();}else{is_phone_exist(this.value);}"  placeholder="Phone Number" type="number"  required id="phone_number" name="phone_number" value="<?php echo $ph; ?>" class="form-control" style="width:73%; float:left; margin-left:2%;">
              </div>
            </div>
            <div class="form-group">
              <label for="email" class="control-label col-md-3 col-sm-3 col-xs-12">Email</label>
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input placeholder="email" onblur="is_email_exist(this.value)"  required id="email" class="form-control col-md-7 col-xs-12" type="email" name="email" value="<?php echo $user->email; ?>">
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="name" name="name" required="required" placeholder="User Name" class="form-control col-md-7 col-xs-12" value="<?php echo $user->name; ?>">
              </div>
            </div>
             <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="password" id="password" name="password" value=""  placeholder="Leave blank if you don't want to change" class="form-control col-md-7 col-xs-12" minlength="6" >
              </div>
            </div>
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="password" id="c_password" name="c_password" onblur="check_password(this.value)"  placeholder="Leave blank if you don't want to change" value="" class="form-control col-md-7 col-xs-12">
                <span id="span_error" style="color: red; display: none;">Password Didn't Match</span>
              </div>
            </div>
            <div class="form-group">
              <label class="control-label col-md-3 col-sm-3 col-xs-12" for="c_password">  Outstanding Balance
              </label>

              <div class="col-md-6 col-sm-6 col-xs-12">
                <input type="text" id="out_balance" name="out_balance"  required="required" placeholder="Outstanding Balance" class="form-control col-md-7 col-xs-12" value="<?php echo $user->outstanding_balance; ?>">
              </div>
            </div>
<!--  -->
...
function  is_email_exist(number)
{
  ...
  if(email)
  {
    ...
    ({
      ...
      dataType : "json",
      data : {"email" : email, "id" : <?php echo $_GET['id']; ?>},
      success : function(data)
      {
         if(data==2)
         {
