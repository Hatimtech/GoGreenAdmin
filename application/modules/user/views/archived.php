                 ...
                 foreach($users as $key => $user)
                 {
                   ...
                   // $expiry_date = $users[$key]['expiry_date'];
                    ...
                    <tr>
                      ...
                      echo"<a href='".base_url()."add_customer/edit?id=".$id."&from=user/archived' class='btn btn-primary'>Edit</a>";
                      echo"<a href='".base_url('user/unarchive?id='.$id.'')."' class='btn btn-dark'>Un-Archive</a>";
                      echo "</td>";
                      if($is_stop ==1)
                      {
                        echo"
