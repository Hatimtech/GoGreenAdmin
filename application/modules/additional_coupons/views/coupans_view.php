...
<div class="right_col" role="main">
  ...
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        <div class="x_title">
          <h2>Additional Services Coupons</h2>
          <a href="<?php echo base_url()?>additional_coupons/add_coupans">
              ...
              <?php
                 foreach($coupans as $key => $value)
                 {
                  ...
                  <tr>
                    ...
                    <td>
                      <a href='".base_url()."additional_coupons/delete_coupans?id=".$value['id']."' class='btn btn-danger btn-sm'><i class='fa fa-trash-o m-right-xs'></i>Delete
                      </a>
                      <a href='".base_url()."additional_coupons/add_coupans?id=".$value['id']."' class='btn btn-info btn-sm'><i class='fa fa-edit m-right-xs'></i>Edit
                      </a>
                    </td>
                  </tr>";
                 }
