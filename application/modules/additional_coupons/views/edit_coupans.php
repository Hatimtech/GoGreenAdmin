...
<div class="right_col" id="cool" role="main">
  <div class="row">
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      ...
      <div class="x_content">
        <form enctype="multipart/form-data" method="post" action="<?php echo base_url()?>additional_coupons/add_coupans?id=<?php echo $coupan['id'];?>" id="" data-parsley-validate class="form-horizontal form-label-left">
        ...
        <div class="form-group">
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <input type="text" name="valid_upto" value="<?php echo  $valid_upto;?>"  class="form-control has-feedback-left" id="custom_calender" placeholder="First Name" aria-describedby="inputSuccess2Status2">
            <span class="fa fa-calendar-o form-control-feedback left" aria-hidden="true"></span>
          ...
          <div class="col-md-6 col-sm-6 col-xs-12">
            <select name="additional_services_id" required="required" class="form-control col-md-7 col-xs-12">
              ...
              foreach ($additional as $key => $value) {
                $sel = ($value[id] == $coupan['additional_services_id']) ? 'selected' : '';
                echo "<option value='".$value[id]."' ".$sel.">".$value['service_name']."</option>";
              }
              ?>
            </select>
          </div>
